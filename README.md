...
- [User guide](#user-guide)
  ...
  * [Инструкция по использования репозитория c docker image из gitlab Registry](https://gitlab.itnap.ru/machine-learning/computer-vision/tsar_pipeline_runner/-/tree/release_tests#пример-использования-репозитория-с-gitlab-registry)
