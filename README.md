# tsar_pipeline
### Данный репозиторий содержит решение мультикласс, мультилейбл классификации, Metric Learning и NLP
----
### Содержание
...
- [Callbacks](#использование-колбэков-в-пайплайне)
 ...
 ### Запуск и изменение nlp решения
  ...
  - Изменение моделей обучения:
     - Изменить в ```.yml``` файле название модели (доступные модели можно посмотреть в таблице([Информация о моделях](#информация-о-моделях)). Пока доступны только ```sberbank модели```
