...
def test_classification_config_runner(config_list):
    for i in config_list:
        ...
        args, unknown_args = parser.parse_known_args(['--config', f'src/classification/tests/test_configs/multiclass/{i}', '--check'])
...
def test_multiclass_classification():
    path=  Path('src/classification/tests/test_configs').absolute() / 'multiclass'
